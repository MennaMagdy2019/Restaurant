...
export const sample_foods: Food[]=[
  {
    ...
    desc:'Recipe for a delicious healthy chicken 🐔 in a special roti for dinner Then, add in mayonnaise to the mixture whilst continuously mixing – leave this to one side for later use.',
